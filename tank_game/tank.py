...
class Shell(pygame.sprite.Sprite):
    def __init__(self,coords, theta=45):
        ...
        self.speed = 18 # meters per second
        ...
        self.image = pygame.image.load('tank_game/assets/PNG/Retina/tank_bullet4.png')
        self.image = pygame.transform.rotozoom(self.image, 0, 0.6)
        self.rect = self.image.get_rect()
    ...
    def update(self,dt):
        ...
        self.x += self.dot_x * self.scale * dt # pos in pix
        self.y += self.dot_y * self.scale * dt # pos in pix
